...
| ------------ | ------------------------------------------------------------ | -------- | -------------------------------------------------- |
| 0x80         | b0: Green LED brightness<br />b1: Orange/RED LED brightness  | OK       | Adjusts backlight.                                 |
| 0x81         |                                                              | 0x82...  | Status?                                            |
| 0x83         |                                                              | 0x84...  | Status?                                            |
| 0x10         | [0]: Region ID<br/>[2:3]: Sub-region ID <br/>[4]: ??? Usually 0x0<br/><br />[5]: Font Style<br />[6]: Width<br/>[8]: X Position<br/>[10]: Y Position<br/>[11+]: Text data | OK       | Setup layer on region, with optional text data.             |
| 0x11         | [0]: Region ID<br/>[2:3]: Sub Region ID<br/>[4]: display? 0x03 invis 0x02 show????, 0x8 for normal, sometimes 0x2<br/>[5]: Style<br/>    # 0x00, normal<br/>    # 0x10, right aligned<br/>    # 0x20, blinking<br/>    # 0x40, inverted <br/>    # 0x80, underline<br />[6+]NEW text data | OK       | Adjust layer presentation.                         |
| 0x60         | [0]: Region ID<br />[2]: Clear Flag (0x0)                    | OK       | CLEAR region.                                      |
| 0x70         | [0]: Region ID<br />[2]: Draw Flag (0 or 1)                  | OK       | DRAW region. (seems to also clear regions like 0x60)                                       |
...
- 4 font sizes
- 4 font styles: underscore, solid background, flashing, and align right styles. Can be combined
