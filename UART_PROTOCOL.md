...
| 0x10         | [0]: Region ID<br/>[2:3]: Sub-region ID <br/>[4]: layer visibility??? Usually 0x0<br/><br />[5]: Font Style<br/>    # 0x00 Small<br/>    # 0x01 Large<br/>    # 0x02 Medium (normal)<br/>    # 0x04/0x14 Time (left 2 time digits are 0x04, the right are 0x14)<br />[7:?6]: Width<br/>[9:8]: X Position<br/>[10]: Y Position<br/>[11+]: Text data | OK       | Setup layer on region, with optional text data.             |
